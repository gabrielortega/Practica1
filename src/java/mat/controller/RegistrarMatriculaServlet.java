...
import mat.business.Matricula;
import mat.data.MatriculaDB;

/**
 *
 * @author alumno
 */
@WebServlet(name = "RegistrarMatriculaServlet", urlPatterns = {"/RegistrarMatriculaServlet"})
public class RegistrarMatriculaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("join")) {
            url = "/registroAlumno.jsp";    // la pagina "join" 
        }
